...
function pagination_list_render($list)
{
	...
	$html .= '<ul class="pagination justify-content-center justify-content-sm-start">';
...
function pagination_item_inactive(&$item)
{
	...
	if (isset($item->active) && $item->active)
	{
		...
		return '<li class="page-item active"><a class="page-link" href="#" aria-label="' . $aria . '">' . $item->text . '<span class="sr-only">(current)</span></a></li>';
	}

	// Doesn't match any other condition, render a normal item
	return '<li class="page-item disabled"><a class="page-link" href="#" tabindex="-1">' . $item->text . '</a></li>';
}
